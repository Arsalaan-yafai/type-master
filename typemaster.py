...
l1 = ['arsalaan', 'yafai', 'coder', 'coding', 'gym', 'bullet', 'owl', 'rehan', 'faizan', 'physics',
      'mango', 'maths','red','blue','bike','barbell','deadlift','benchpress','bench','bus','squat','lats','abs','bicep','tricep','shoulder','back','laptop','india','orange','red','green','black','white','car','cloud','saudi']
